...
export default function Clipboard() {
    ...
    return (
        <button
            ...
            {!clicked && (
                <span
                    className={`fs-4 ${styles.responsive}`}>
                    {' '}
            ...
            {clicked && (
                <span
                    className={`fs-4 text-success ${styles.responsive}`}>
                    {' '}
            ...
            <span>
                {!clicked && (
                    <FaRegClipboard className='fs-3' />
                )}
                {clicked && (
                    <FaClipboardCheck className='text-success fs-3' />
                )}
            </span>
        </button>
    );

        ...
        <div className={`${styles.project} mb-5 p-0 `}>
            <a
                ...
                <img
                    ...
                    className='rounded-top project-hover'
                />
                <div
                        ...
                        <li className=''>
                            <a
                                ...
                                <Badge
                                    bg='black'
                                    text='light'
                                    className={`d-flex align-items-center hover-translate gap-2 fs-5 px-5 ${styles.badge}`}>
                                    <svg
                                        stroke='currentColor'
                                        fill='none'
                                        stroke-width='2'
